...
svg(file="diagrams/coverage_run1.svg",12,8)
...
### combine the plots and write them to an svg file
svg(file="diagrams/negatives_coverage_run1.svg",12,8)
...
#cumulative.all<-ggplot(read.stats, aes(x=order, y=csum, group=as.factor(clusters_min_cov))) +
 ...
 # geom_line(aes(colour=as.factor(clusters_min_cov))) +
  ...
  #theme(axis.text = element_text(size = rel(1.2), colour = "black", angle=90)),
  #       axis.title = element_text(size = rel(1.2)))
...
#svg(file="diagrams/cumulative_read_depth_run1.svg",12,8)
...
### Plot above as a svg
svg(file="diagrams/trimming_summary_moths_only_run1.svg",12,8)
samples.only
dev.off()
...
### Plot above as a svg
svg(file="diagrams/trimming_summary_sample_types_run1.svg", 12, 8)
sample.types
dev.off()
...
svg(file="diagrams/well_composition_run1.svg", width=12, height=8)

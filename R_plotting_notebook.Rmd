...
The read depth for a minimum cluster coverage of one seems a little weird so I'll plot the cumulative total reads for both all minimum cluster sizes and for just one and six.
...
svg(file="diagrams/cumulative_read_depth.svg",12,4)
grid.arrange(cumulative.all, cumulative.subs, ncol=2)
dev.off()

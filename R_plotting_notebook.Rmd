...
svg(file="diagrams/coverage.svg",12,8)
...
### combine the plots and write them to an svg file
svg(file="diagrams/negatives_coverage.svg",12,8)
...
svg(file="diagrams/cumulative_read_depth.svg",12,8)
...
### Plot above as a svg
svg(file="diagrams/trimming_summary_all_samples.svg",12,8)
all.samples
dev.off()
...
### Plot above as a svg
svg(file="diagrams/trimming_summary_moths_only.svg",12,8)
samples.only
dev.off()
...
### Plot above as a svg
svg(file="diagrams/trimming_summary_sample_types.svg", 12, 8)
sample.types
dev.off()
...
svg(file="diagrams/well_composition.svg", width=12, height=8)

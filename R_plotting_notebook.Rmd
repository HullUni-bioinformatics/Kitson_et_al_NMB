...
Lets see how the number of clusters retained and read depth per well changes with different minimum cluster sizes.

```{r}
read.stats<-read.csv(file="data2/combined_read_stats.csv", stringsAsFactors=FALSE, header=TRUE)
#read.stats<-subset(read.stats, clusters_min_cov>40)

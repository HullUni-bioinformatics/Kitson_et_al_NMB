...
my.assignments$Fungi<-rowSums(my.assignments[c("Beauveria_bassiana","Penicillium","Cordycipitaceae","Ascomycota")])
my.assignments<-my.assignments[c(1,3:7,10,13,12)]
...
### Total all the reads
my.assignments$total<-rowSums(my.assignments[c(2:9)])
...
hit.hist<-data.frame(OTUs = rowSums(my.assignments.samps.only[c(2:9)] != 0), type=my.assignments.samps.only$type)
```

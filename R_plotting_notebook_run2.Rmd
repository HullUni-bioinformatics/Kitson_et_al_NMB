...
svg(file="diagrams/all_clusterdepths_run2.svg",12,8)
grid.arrange(all.clusters, neg.clusters, ncol=1)
dev.off()
...
```{r}
### combine the plots and write them to an svg file
svg(file="diagrams/all_readdepths_run2.svg",12,8)
grid.arrange(all.reads, neg.reads, ncol=1)
dev.off()

...
svg(file="diagrams/Figure3_run2.svg",12,8)
grid.draw(g.reads)
dev.off()
...
### Write the grobbed ggplots to an svg
svg(file="diagrams/Figure4_run2.svg",12,8)
...
### Plot above as a svg
svg(file="diagrams/Figure5_run2.svg",12,8)
samples.only
dev.off()
...
### Plot above as a svg
svg(file="diagrams/Figure6_run2.svg", 12, 8)
sample.types
dev.off()
...
paste("PCR success = ", round((1-(sum(my.plates$strength=="fail")/nrow(counting)))*100,1),"%",sep="")
paste("Sequencing success = ", round((sum(counting$queries>0)/nrow(counting))*100,1),"%",sep="")
...
svg(file="diagrams/Figure7_run2.svg", width=12, height=8)
